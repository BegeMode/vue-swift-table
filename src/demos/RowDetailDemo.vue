...
<template>
  <div class="demo-wrapper">
    <div class="header-params">
      ...
      <p>
          This demo shows how to use the Row Detail feature. 
          Toggle "Mobile Mode" to hide columns and see them in the detail view instead.
      </p>
      <div class="controls">
          <button @click="isMobile = !isMobile">
              Toggle Mobile Mode ({{ isMobile ? 'ON' : 'OFF' }})
          </button>
      </div>
    </div>
