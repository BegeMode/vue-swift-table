...
<template>
  <div class="demo-wrapper">
    <div class="header-params">
      ...
      <p>
        Uses <code>&lt;template #header-name&gt;</code> and <code>&lt;template #col-name&gt;</code> to customize content.
      </p>
    </div>
    ...
    <div class="table-wrapper">
      ...
      >
        ...
        <template #col-name="{ row }">
           <span v-if="row">Hi: <strong>{{ row.name }}</strong></span>
        </template>
        ...
        <template #col-age="{ row }">
            <div v-if="row" style="width:100%;height:40px;border:solid 1px #ddd;padding:3px; position: relative;">
               <div style="background:#999;height:100%;position: absolute; top: 0; left: 0;" :style="{'width': row.age + '%'}"></div>
